...
// const wsLink = new WebSocketServer({
//   port: 4000,
//   path: '/graphql',
// });
...
//   new SubscriptionClient("wss://localhost:4000/graphql/subscriptions", {
//     reconnect: true
//   }, ws)
// );
...
function createApolloClient() {
  ...
  const httpLinkNew = new HttpLink({
...
// === working
  ...
  typeof window !== 'undefined'
    ? new WebSocketLink({
      uri: process.env.NEXT_PUBLIC_GRAPHQL_API_ENDPOINT_SUBSCRIPTION_DEV as string,
      options: {
        reconnect: true,
      },
    })

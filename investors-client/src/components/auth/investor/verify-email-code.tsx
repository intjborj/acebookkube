...
const VerifyEmailCode = ({ id, investorId, regData, saveEmail,codeSent, verifyEmail }: Props) => {
    ...
    return (
        <div>
            {state.codeMatch === true ? <InvestorRegForm defaultValue={state.regValue} id={id} investorId={investorId as string} /> : <VerifyCode />}
        </div>
    )
}
